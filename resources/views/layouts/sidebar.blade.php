    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="flex items-center">
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                ...
                <span class="text-brand-500">e</span><span class="text-gray-900 dark:text-white">KRS</span>
            </div>

            <div x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                class="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500 text-xl font-black text-white shadow-lg shadow-brand-500/20">
                e
            </div>
        </a>
    </div>
